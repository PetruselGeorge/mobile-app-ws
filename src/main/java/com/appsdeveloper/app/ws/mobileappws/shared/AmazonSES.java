...
public class AmazonSES {
    ...
    final String HTML_BODY = "<h1>Please verify your email address</h1>"
            ...
            + "<a href='http://localhost:8080/mobile-app-ws/users/email-verification.html?token=$tokenValue'> "
    ...
    final String TEXT_BODY = "Please verify your email address."
            ...
            + "http://localhost:8080/mobile-app-ws/users/email-verification.html?token=$tokenValue"
            + "Thank you! ";
    ...
    final String PASSWORD_REQUEST_HTMl_BODY = "<h1>A request to reset your password</h1>"
            ...
            + "<a href='http://localhost:8080/mobile-app-ws/users/password-reset.html?token=$tokenValue'>"
    ...
    final String PASSWORD_REQUEST_TEXT_BODY = "A request to reset your password "
            ...
            + "otherwise please click on the link below: "
            + "http://localhost:8080/mobile-app-ws/users/password-reset.html?token=$tokenValue"
            + "Thank you! ";
